...
const CartSlice = createSlice({
    ...
    initialState:{
        cartItems: [],
        actualCartItems: localStorage.getItem('actualcartitems') ? 
        JSON.parse(localStorage.getItem('actualcartitems')) : [],
        numberOfItems: localStorage.getItem('numberofitems') ? 
        JSON.parse(localStorage.getItem('numberofitems')) : 0,
    ...
    reducers:{
        addToCart : (state, action) =>{
            ...
            localStorage.setItem('actualcartitems', JSON.stringify(state.actualCartItems))
